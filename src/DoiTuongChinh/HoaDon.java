 ...
 * @author h
 */
public class HoaDon extends DoiTuong{
    ...
    public HoaDon(int maHoaDon, String tenNguoiBan, String ngayBan, String tenKhachHang, String SDTKhachHang, ArrayList<SanPham> listSanPham) {
