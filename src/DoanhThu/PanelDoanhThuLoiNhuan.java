 ...
 * @author h
 */
public class PanelDoanhThuLoiNhuan extends javax.swing.JPanel {
     ...
     */
    public PanelDoanhThuLoiNhuan() throws ParseException, CloneNotSupportedException, Exception {
        initComponents();
    ...
    private void initComponents() {
        ...
        lbNotice.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGap(29, 29, 29)
                                .addComponent(dateChFrom, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void dateChToPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_dateChToPropertyChange
        ...
        try{
            ...
            if(e.getMessage() != null){
                this.txtfShowDoanhThu.setText("");
                this.txtfShowLoiNhuan.setText("");
                ((DefaultTableModel)this.tableChiPhiPhatSinh.getModel()).setRowCount(0);
                lbNotice.setText(e.getMessage());
            }  
        }
    ...
    private void setTxtfShowDoanhThu() throws ParseException, CloneNotSupportedException, Exception {
        int totalDoanhThu = HomeFrame.cuaHang.thongKeDoanhThu(fromTime, toTime);
        txtfShowDoanhThu.setText(""+totalDoanhThu);
    }

    private void setTxfShowLoiNhuan() throws ParseException, CloneNotSupportedException, Exception {
        int loiNhuan = HomeFrame.cuaHang.thongKeLoiNhuan(fromTime, toTime);
        txtfShowLoiNhuan.setText(""+loiNhuan);
    }

    private void setTableDoanhThu(long fromTime, long toTime) throws ParseException, CloneNotSupportedException, Exception {
        DefaultTableModel model = (DefaultTableModel) this.tableBangDoanhThu.getModel();
        model.setRowCount(0);
        ArrayList<SanPham> thongKeDoanhThu = HomeFrame.cuaHang.getDanhSachSanPhamDaBan(fromTime, toTime);
    ...
    private void setTableChiPhi(long fromTime, long toTime) throws CloneNotSupportedException, Exception {
        DefaultTableModel model = (DefaultTableModel) this.tableChiPhiPhatSinh.getModel();
        model.setRowCount(0);
        ArrayList<ChiPhiKhac> listChiPhiRows = new ArrayList<>(HomeFrame.cuaHang.getDanhSachChiPhi(fromTime,toTime));
        
        Object[] newRow ;
        for(ChiPhiKhac x:listChiPhiRows){
            newRow = new Object[]{model.getRowCount()+1,x.getTenChiPhi(),x.getSoTien()};
            model.addRow(newRow);
        }
    }

    private void setContentPane() throws ParseException, CloneNotSupportedException, Exception {
